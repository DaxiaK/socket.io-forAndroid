...
import com.example.socketio.android.SocketIOAction;
...
{
	/** jim@shuttle 20150130 debug and braodcast */
	// private final String TAG = "IOConnection";
	private static Context mContext = null;
	private WakeLock wakelock;
	private static String wakeLockTag;
	/** Debug logger */
	...
	private class HearbeatTimeoutTask extends TimerTask
	{
		...
		public void run()
		{
			...
			SendErrorMessageWithBroadcast(SocketIOAction.SOCKETIO_ERRORMESSAGE_HEARTBEATTIMEOUT);
		}
	}
	 ...
	 */
	static public IOConnection register(String origin, SocketIO socket, Context context)
	{
		mContext = context;
		wakeLockTag = origin;
	...
	/**
	 * We focus 3 type error message : SocketIO 1+0,Socket heartbeat Timeout,error handshaking.
	 * 
	 */
	private void SendErrorMessageWithBroadcast(String Action)
	{
		Intent errorIntent = new Intent();
		errorIntent.setAction(Action);
	...
	private synchronized void resetTimeout()
	{
		...
		if (getState() != STATE_INVALID)
		{
			...
			// g.e(TAG, "TIMEOUT=" + String.valueOf(closingTimeout + heartbeatTimeout));
			// count = 0;
		}
	}
