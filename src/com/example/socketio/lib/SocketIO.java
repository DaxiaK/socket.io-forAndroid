 ...
 */
package com.example.socketio.lib;
...
public class SocketIO
{
	 ...
	 */
	public SocketIO(final String url, Context context) throws MalformedURLException
	{
		if (url == null)
			throw new RuntimeException("url may not be null.");
		setAndConnect(new URL(url), null, context);
	}
	 ...
	 *             the malformed url exception
	 */
	public SocketIO(final String url, Properties headers, Context context) throws MalformedURLException
	{
		if (url == null)
			throw new RuntimeException("url may not be null.");
		if (headers != null)
	 ...
	 *             the malformed url exception
	 */
	public SocketIO(final String url, final IOCallback callback, Context context) throws MalformedURLException
	{
		connect(url, callback, context);
	}
	 ...
	 *            the callback
	 */
	public SocketIO(final URL url, final IOCallback callback, Context context)
	{
		if (setAndConnect(url, callback, context) == false)
	 ...
	 *            the url
	 */
	public SocketIO(final URL url, Context context)
	{
		setAndConnect(url, null, context);
	}
	 ...
	 *            the callback
	 */
	public void connect(final String url, final IOCallback callback, Context context) throws MalformedURLException
	{
		if (setAndConnect(new URL(url), callback, context) == false)
		{
	 ...
	 *            the callback
	 */
	public void connect(URL url, IOCallback callback, Context context)
	{
		if (setAndConnect(url, callback, context) == false)
		{
			if (url == null || callback == null)
	 ...
	 *            the callback
	 */
	public void connect(IOCallback callback, Context context)
	{
		if (setAndConnect(null, callback, context) == false)
		{
			if (callback == null)
	 ...
	 */
	private boolean setAndConnect(URL url, IOCallback callback, Context mContext)
	{
		...
		if (this.callback != null && this.url != null)
		{
			...
			this.connection = IOConnection.register(origin, this, mContext);
			return true;
		}
		return false;
	}
	 ...
	 * necessarily the ones set by {@link #addHeader(String, String)} or {@link #SocketIO(String, Properties)} but the ones used for the
	 * handshake.
	 * 
